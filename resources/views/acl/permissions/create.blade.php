        ...
        <div class="pcoded-wrapper">
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                    ...
                    <!-- [ breadcrumb ] start -->
                    <x-breadcrumb title="Create Permission" :breadcrumbs="[['name' => 'Permissions', 'allow' => true, 'link' => route('permissions.index')],['name' => 'Create', 'allow' => true, 'link' => route('permissions.create')]]" />
                    <!-- [ breadcrumb ] end -->
