            ...
            return Datatables::of($currencies)
                ...
                ->addColumn('action', function ($currency) use ($user) {
                    ...
                    //if($user->hasrole('Super Admin') || $user->can('Edit Divisions'))
                        $action .= '<a href="'. route('currencies.edit', $currency->uuid) .'" data-edit="true" class="text-primary me-2" data-toggle="tooltip" title="'.__('Edit Currency').'"><i class="feather icon-edit"></i></a>';
                    //if($user->hasrole('Super Admin') || $user->can('Delete Divisions'))
                        $action .= '<a href="'. route('currencies.destroy', $currency->uuid) .'" class="text-danger btn-delete" data-toggle="tooltip" title="'.__('Delete Currency').'"><i class="feather icon-trash-2"></i></a>';
